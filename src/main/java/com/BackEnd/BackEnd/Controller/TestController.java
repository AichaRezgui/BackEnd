...
public class TestController {
    ...
    public ResponseEntity<Void> deleteTest(@PathVariable Long id) {
        // Supprimer les questions associées (ou les dissocier) avant de supprimer le test
        questionService.deleteQuestionsByTestId(id); // Méthode à implémenter dans le service QuestionService
